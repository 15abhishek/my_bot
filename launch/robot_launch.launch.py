...
def generate_launch_description():
    ...
    declare_map_yaml_cmd = DeclareLaunchArgument(
        'map',
        default_value=os.path.join(my_bot_dir, 'maps', 'map.yaml'),
    ...
    declare_params_file_cmd = DeclareLaunchArgument(
        'params_file',
        default_value=os.path.join(my_bot_dir, 'config', 'nav2_params.yaml'),
    ...
    declare_mapper_online_async_param_cmd = DeclareLaunchArgument(
        'async_param',
        default_value=os.path.join(my_bot_dir, 'config', 'mapper_params_online_async.yaml'),
        description='Set mappers online async param file')

    declare_rviz_config_file_cmd = DeclareLaunchArgument(
        'rviz_config',
        default_value=os.path.join(my_bot_dir, 'rviz', 'nav2_default_view.rviz'),
